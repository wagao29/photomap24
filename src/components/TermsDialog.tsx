      ...
      <div className='flex flex-col items-center h-full font-bold pb-4'>
        ...
        <div className='overflow-scroll hidden-scrollbar p-2'>
          <ul className='space-y-4 list-inside'>
            ...
            <li>
              <span className='text-sm'>第1条（規約の適用）</span>
              <ol className='space-y-1 text-xs list-decimal list-inside'>
                <li>
                  本規約は、ユーザーと本サービスの利用に関わる一切の関係に適用されるものとします。
                </li>
                <li>
                  利用者は、本サービスの利用をもって、本規約の内容を承諾頂いたものとみなし、適用されるものとします。
                </li>
              </ol>
            </li>
            <li>
              <span className='text-sm'>第2条（利用登録）</span>
              <ol className='space-y-1 text-xs list-decimal list-inside'>
                <li>
                  押したスタンプのデータ保持やスタンプの作成には、Googleアカウントでのログインが必要であり、
                  利用者は、アカウントを管理する責任を負うものとします。
                </li>
                <li>
            ...
            <li>
              <span className='text-sm'>第3条（禁止事項）</span>
              <ol className='space-y-1 text-xs list-decimal list-inside'>
                ...
                <li>
                  ...
                  <ol className='ml-1 list-disc list-inside'>
                    <li>過度に暴力的な表現</li>
                    <li>露骨な性的表現</li>
            ...
            <li>
              <span className='text-sm'>第4条（本サービスの提供の停止等）</span>
              <ol className='space-y-1 text-xs list-decimal list-inside'>
                <li>
            ...
            <li>
              <span className='text-sm'>第5条（著作権）</span>
              <ol className='space-y-1 text-xs list-decimal list-inside'>
                <li>
                  ユーザーは、自ら著作権等の必要な知的財産権を有するか、または必要な権利者の許諾を得た文章や画像に関してのみ、
                  スタンプ作成に使用する画像やユーザープロフィール画像としてアップロードをすることができるものとします。
                </li>
                <li>
                  ユーザーが本サービスを利用してアップロードした文章、画像等の著作権については、当該ユーザーその他既存の権利者に留保されるものとします。
                  ただし、当社は、本サービスを利用してアップロードされた文章、画像等について、
                  本サービスの改良、品質の向上、または不備の是正等ならびに本サービスの周知宣伝等に必要な範囲で利用できるものとし、
                  ユーザーは、この利用に関して、著作者人格権を行使しないものとします。
                </li>
                <li>
                  前項本文の定めるものを除き、本サービスおよび本サービスに関連する一切の情報についての著作権および
                  その他の知的財産権はすべて当社または当社にその利用を許諾した権利者に帰属し、
                  ユーザーは無断で複製、譲渡、貸与、翻訳、改変、転載、公衆送信、伝送、配布、出版、営業使用等をしてはならないものとします。
                </li>
              </ol>
            </li>
            <li>
              <span className='text-sm'>第6条（利用制限および登録抹消）</span>
              <ol className='space-y-1 text-xs list-decimal list-inside'>
                <li>
            ...
            <li>
              <span className='text-sm'>第7条（退会）</span>
              <ol className='space-y-1 text-xs list-decimal list-inside'>
                <li>
            ...
            <li>
              <span className='text-sm'>第8条（保証の否認および免責事項）</span>
              <ol className='space-y-1 text-xs list-decimal list-inside'>
                <li>
            ...
            <li>
              <span className='text-sm'>第9条（サービス内容の変更等）</span>
              <ol className='space-y-1 text-xs list-decimal list-inside'>
                <li>
            ...
            <li>
              <span className='text-sm'>第10条（利用規約の変更）</span>
              <ol className='space-y-1 text-xs list-decimal list-inside'>
                <li>
            ...
            <li>
              <span className='text-sm'>第11条（個人情報の取扱い）</span>
              <ol className='space-y-1 text-xs list-decimal list-inside'>
                <li>
            ...
            <li>
              <span className='text-sm'>第12条（準拠法・裁判管轄）</span>
              <ol className='space-y-1 text-xs list-decimal list-inside'>
